...
export const FLEET = [
  ...
  },
  {
    ...
    color: "Custom",
    features: ["Didampingi di Mobil Sendiri", "Langsung Kenal Karakter Kendaraan", "Bisa Matic / Manual", "Penyesuaian Garasi Rumah"],
    desc: "Sudah punya mobil di garasi tapi belum berani bawa ke jalan raya? Tim kami siap mendampingi langsung di mobil pribadi Anda!",
  },
];
