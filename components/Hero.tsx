  ...
  return (
    <section className="pt-32 sm:pt-36 pb-20 relative overflow-x-clip bg-gradient-to-b from-[#ffffff] via-[#f8f9fc] to-[#ffffff]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Welcome Header */}
        <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-14 space-y-6">
          <div className="flex justify-center">
            <div className="text-xs font-mono font-semibold uppercase tracking-wider text-[#0F7A73] flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <a
              href="#jadwal"
              className="antigravity-btn-primary w-full sm:w-auto text-sm py-3 px-6 shadow-sm gap-2 rounded-lg"
            >
            ...
            <a
              href="#kalkulator"
              className="antigravity-btn-secondary w-full sm:w-auto text-sm py-3 px-6 gap-2 rounded-lg"
            >
          ...
          {/* Guarantee Items */}
          <div className="flex flex-wrap items-center justify-center gap-y-2 gap-x-6 pt-2 text-xs text-[#45474d]">
        ...
        <div className="max-w-5xl mx-auto mb-12 sm:mb-14">
          <div className="p-2 sm:p-2.5 bg-white shadow-sm border border-[rgba(33,34,38,0.08)] rounded-xl">
            ...
            <div className="mt-2.5 pt-2 px-1 border-t border-[rgba(33,34,38,0.06)] flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-[#45474d]">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-2.5 sm:gap-3">
            {capabilities.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-3 bg-[#f8f9fc] border border-[rgba(33,34,38,0.06)] rounded-lg text-center flex flex-col items-center justify-center group hover:border-[#0F7A73]/30 transition-all"
                >
                  <Icon className="w-5 h-5 text-[#121317] group-hover:text-[#0F7A73] transition-colors mb-1.5" />
